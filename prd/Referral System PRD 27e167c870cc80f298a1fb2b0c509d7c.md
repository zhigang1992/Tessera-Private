...
- 利用其 _奖励层_、_按时间重置计数_、_日期范围_ 等功能，定期清零推荐计数并限制奖励有效期[support.referralhero.com](https://support.referralhero.com/campaign-builder/rewards/reward-settings#:~:text=Time)[support.referralhero.com](https://support.referralhero.com/campaign-builder/rewards/reward-settings#:~:text=Date%20Range)；
...
- 使用 ReferralHero 的 _日期范围_ 设置，在限定日期内自动启用和关闭[support.referralhero.com](https://support.referralhero.com/campaign-builder/rewards/reward-settings#:~:text=Date%20Range)。
...
10月19日的版本尚未开始正式的trading，所以我们需要上线1.注册账户
