...
const socialLinks = [
  ...
  },
  {
    ...
    icon: (
      <svg className="h-4 w-4 sm:h-[18px] sm:w-[18px]" viewBox="0 0 21 20" fill="currentColor">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          {socialLinks.map((social) => (
            <a
              ...
              className='flex h-8 items-center justify-center rounded-sm bg-[#D2FB95] text-black transition-transform duration-200 hover:-translate-y-0.5 hover:opacity-90 w-9 sm:w-16'
            >
              {social.icon}
            </a>
          ))}
