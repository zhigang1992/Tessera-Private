      ...
      <div className="flex items-center justify-center gap-10">
        ...
        <div className="flex items-center gap-4 py-2">
          ...
          <a
            ...
            className="flex items-center justify-center w-16 h-8 hover:opacity-80 transition-opacity"
          >
            <svg width="22" height="17" viewBox="0 0 22 17" fill="currentColor" className="text-black dark:text-white">
          ...
          <a
            ...
            className="flex items-center justify-center w-16 h-8 hover:opacity-80 transition-opacity"
          >
            <svg width="19" height="19" viewBox="0 0 19 19" fill="currentColor" className="text-black dark:text-white">
          ...
          <a
            ...
            className="flex items-center justify-center w-16 h-8 hover:opacity-80 transition-opacity"
          >
            <svg width="22" height="22" viewBox="0 0 22 22" fill="currentColor" className="text-black dark:text-white">
