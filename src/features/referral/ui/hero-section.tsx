      ...
      <div className="flex flex-col gap-3 text-[#4B5563] dark:text-[#D1D5DB] sm:flex-row sm:items-center sm:gap-8">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <a
            ...
            className="flex h-9 w-9 items-center justify-center rounded-full bg-[#D2FB95] text-black transition-transform duration-200 hover:-translate-y-0.5 hover:opacity-90 sm:h-11 sm:w-11"
          >
          ...
          <a
            ...
            className="flex h-9 w-9 items-center justify-center rounded-full bg-[#D2FB95] text-black transition-transform duration-200 hover:-translate-y-0.5 hover:opacity-90 sm:h-11 sm:w-11"
          >
            <svg className="h-4 w-4 sm:h-[18px] sm:w-[18px]" viewBox="0 0 21 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              <path
                fillRule="evenodd"
                clipRule="evenodd"
          ...
          <a
            ...
            className="flex h-9 w-9 items-center justify-center rounded-full bg-[#D2FB95] text-black transition-transform duration-200 hover:-translate-y-0.5 hover:opacity-90 sm:h-11 sm:w-11"
          >
            <svg className="h-4 w-4 sm:h-5 sm:w-5" viewBox="0 0 22 22" fill="currentColor">
