                ...
                >
                  <div className="w-[140px] lg:w-[180px]">
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-xs lg:text-sm font-semibold text-[#404040] uppercase">
                        {item.token}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="w-[60px] lg:flex-1">
                    <span className="text-xs lg:text-sm text-black">{item.type}</span>
                  </div>
                  <div className="w-[100px] lg:flex-1 text-xs lg:text-sm text-black">
                    {item.account}
                  </div>
                  <div className="w-[120px] lg:flex-1 text-xs lg:text-sm text-black">
                    {item.time}
                  </div>
                </div>
              ))
