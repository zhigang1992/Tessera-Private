...
export function MyTradeHistory() {
  ...
  return (
    <div className="rounded-2xl bg-white dark:bg-card px-3.5 py-4 lg:py-6">
      <div className="overflow-x-auto">
        <div className="flex flex-col gap-2.5 min-w-[600px]">
          {/* Header */}
          <div className="flex items-center gap-2.5 px-2.5 text-xs text-muted-foreground">
          ...
          <div className="flex flex-col gap-1">
            {isLoading ? (
              ...
              <div className="flex items-center justify-center py-8">
                <span className="text-sm text-muted-foreground">No trade history</span>
              </div>
            ) : (
                ...
                >
                  <div className="w-[140px] lg:w-[180px]">
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-xs lg:text-sm font-semibold text-foreground uppercase">
                        {item.token}
                      </span>
                    </div>
                  </div>
                  <div className="w-[180px] lg:w-[250px] flex items-center gap-1 text-xs lg:text-sm">
                    <span className="text-foreground">{item.amountIn}</span>
                    <span className="text-[#06a800]">→</span>
                    <span className="text-foreground">{item.amountOut}</span>
                  </div>
                  <div className="w-[60px] lg:flex-1">
                    <span className="text-xs lg:text-sm text-foreground">{item.type}</span>
                  </div>
                  <div className="w-[100px] lg:flex-1 text-xs lg:text-sm text-foreground">
                    {item.account}
                  </div>
                  <div className="w-[120px] lg:flex-1 text-xs lg:text-sm text-foreground">
                    {item.time}
                  </div>
                </div>
              ))
