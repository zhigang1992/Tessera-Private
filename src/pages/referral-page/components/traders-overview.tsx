...
export function TradersOverview() {
  ...
  return (
    <div className="grid grid-cols-1 gap-3 md:gap-4 md:grid-cols-3 md:h-[128px]">
      {/* Trading Volume Card */}
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-b from-[#fff] to-[#D2FB95] p-4 md:p-6 h-full">
      ...
      <div className="rounded-2xl bg-white p-4 md:p-6">
        ...
        <div className="mt-1 md:mt-2 flex items-center gap-2">
          <p className="text-xl md:text-2xl font-medium text-black">{isLoading ? '—' : (data?.activeReferralCode ?? '—')}</p>
        </div>
      </div>
      ...
      <div className="rounded-2xl bg-white p-4 md:p-6">
        ...
        <p className="mt-1 md:mt-2 text-xl md:text-2xl font-medium text-black">
