                ...
                >
                  <div className="w-[140px] lg:w-[180px]">
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-xs lg:text-sm font-semibold text-foreground uppercase">{item.token}</span>
                    </div>
                  </div>
                  ...
                  <div className="w-[100px] lg:flex-1 text-xs lg:text-sm text-foreground">{item.account}</div>
                  <div className="w-[120px] lg:flex-1 text-xs lg:text-sm text-foreground">{item.time}</div>
                </div>
              ))
            )}
          </div>
