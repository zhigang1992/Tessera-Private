...
export function ReferralLeaderboard() {
  ...
  const { data, isLoading } = useLeaderboard(currentPage, 'referral', walletAddress)
              ...
              >
                ...
                <div className="flex flex-col gap-3 p-4 relative w-full">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    {/* Trader Referral */}
                    <div>
                      <p className="text-[10px] font-normal text-[#71717a] mb-1 uppercase">TRADER REFERRAL</p>
                      <div className={cn('flex items-center gap-1 text-sm font-medium', isCurrentUser ? 'text-black' : 'text-[#06a800] dark:text-[#d2fb95]')}>
                    ...
                    {/* Fee Rewards */}
                    <div>
                      <p className="text-[10px] font-normal text-[#71717a] mb-1 uppercase">FEE REWARDS</p>
                      <p className={cn('text-sm', isCurrentUser ? 'text-black' : 'text-foreground dark:text-[#d2d2d2]')}>
                        ${entry.total_rewards_usd.toLocaleString()}
                      </p>
                    </div>
                  </div>
                </div>
