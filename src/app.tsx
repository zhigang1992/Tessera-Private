...
import { AdminMockVolumesPage, AuctionPage, DashboardPage, EligibilityPage, ExplorePage, LeaderboardPage, ReferralPage, SettingsPage, SupportPage, TradePage, TokenDetailPage, WhitelistCheckerPage } from '@/pages'
